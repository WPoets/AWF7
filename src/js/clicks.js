...
app.initClickEvents = function () {
    ...
    $(document).on('click', '.open-panel, .close-panel, .panel-overlay, .modal-overlay, .popup-overlay, .swipeout-delete, .swipeout-close, .close-popup, .open-popup, .open-popover, .close-popover, .open-login-screen, .close-login-screen .smart-select, .toggle-sortable, .open-sortable, .close-sortable, .accordion-item-toggle, .open-picker, .close-picker, .picker-modal-overlay, .tab-link, .floating-button, .close-speed-dial', handleClicks);
